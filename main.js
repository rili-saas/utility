...
var utility = {
  i18n: {
    ...
    flattenMessages: function flattenMessages(nestedMessages, prefix) {
  ...
  navigator: {
    url: {
      ...
      getDomainName: function getDomainName(hostName) {
    ...
    cookie: {
      ...
      add: function add(sKey, sValue, vEnd, sPath, sDomain, bSecure) {
  ...
  validation: function () {
    ...
    return {
      ...
      lengthMax15: function lengthMax15(value) {
        return maxLength(15, value);
      },
      lengthMin6: function lengthMin6(value) {
...
module.exports = utility; // export default utility;
